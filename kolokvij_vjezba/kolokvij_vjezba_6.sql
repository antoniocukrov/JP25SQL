...
# select a.prstena,a.introvertno from prijatelj a inner join prijatelj_ostavljena b on b.prijatelj=a.sifra where a.sifra not in (select prijatelj from prijatelj_ostavljena where prijatelj is not null);
